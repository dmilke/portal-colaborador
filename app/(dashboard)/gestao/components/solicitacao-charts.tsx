...
export function SolicitacaoCharts({ data }: { data: SolicitacaoStats }) {
  return (
    <div className="space-y-6">
          ...
          <div className="h-[280px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data.monthly}>
                ...
                />
                <Bar dataKey="count" name="Solicitações" fill="hsl(var(--primary))" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Solicitações por Departamento</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="h-[280px]">
            <ResponsiveContainer width="100%" height="100%">
